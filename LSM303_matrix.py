...
class LSM303:
    ...
    def __init__(self):
        ...
        # just rotating 180 degrees
        self.xoffset = 143.753
        self.yoffset = 2.054
        self.zoffset = 148.57
    ...
    def getHeading(self, offset=False):
        ...
        tMatrix = ((1.304, .05, .007), (.025, 1.285, .088), (.165, -.033, 1.39))
        tmagX = tMatrix[0][0] * magX + tMatrix[0][1] * magY + tMatrix[0][2] * magZ
        tmagY = tMatrix[1][0] * magX + tMatrix[1][1] * magY + tMatrix[1][2] * magZ
        tmagZ = tMatrix[2][0] * magX + tMatrix[2][1] * magY + tMatrix[2][2] * magZ
        ...
        #heading = 180 * math.atan2(xH2, -yH2) / math.pi  # Y is X
        #heading = 180 * math.atan2(yH2, -xH2) / math.pi    # X is -X
        heading = 180 * math.atan2(yH2, xH2) / math.pi    # X is X
